...
var resolveAnatomyTopicKey = /* @__PURE__ */ __name((topic) => {
  ...
  if (t.includes("head") && t.includes("neck") && t.includes("muscle") || t.includes("mastication") || t.includes("masticator") || t.includes("facial expression") || t.includes("suprahyoid") || t.includes("infrahyoid") || t.includes("tongue")) return "head_neck_muscles";
  return normalizeKey(t);
