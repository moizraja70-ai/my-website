import { onRequestOptions as __api_admin_delete_user_ts_onRequestOptions } from "C:\\Users\\b\\Downloads\\dentedge\\my-website\\functions\\api\\admin-delete-user.ts"
import { onRequestPost as __api_admin_delete_user_ts_onRequestPost } from "C:\\Users\\b\\Downloads\\dentedge\\my-website\\functions\\api\\admin-delete-user.ts"
...
export const routes = [
    {
      ...
      method: "OPTIONS",
      middlewares: [],
      modules: [__api_admin_delete_user_ts_onRequestOptions],
    },
  {
      routePath: "/api/admin-delete-user",
      mountPath: "/api",
      method: "POST",
      middlewares: [],
      modules: [__api_admin_delete_user_ts_onRequestPost],
    },
  {
      routePath: "/api/notes",
      mountPath: "/api",
