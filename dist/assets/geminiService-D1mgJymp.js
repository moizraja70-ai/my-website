import{M as m}from"./index-B6fq6K6S.js";var Tt={};/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */var de;(function(e){e.OUTCOME_UNSPECIFIED="OUTCOME_UNSPECIFIED",e.OUTCOME_OK="OUTCOME_OK",e.OUTCOME_FAILED="OUTCOME_FAILED",e.OUTCOME_DEADLINE_EXCEEDED="OUTCOME_DEADLINE_EXCEEDED"})(de||(de={}));var me;(function(e){e.LANGUAGE_UNSPECIFIED="LANGUAGE_UNSPECIFIED",e.PYTHON="PYTHON"})(me||(me={}));var he;(function(e){e.SCHEDULING_UNSPECIFIED="SCHEDULING_UNSPECIFIED",e.SILENT="SILENT",e.WHEN_IDLE="WHEN_IDLE",e.INTERRUPT="INTERRUPT"})(he||(he={}));var I;(function(e){e.TYPE_UNSPECIFIED="TYPE_UNSPECIFIED",e.STRING="STRING",e.NUMBER="NUMBER",e.INTEGER="INTEGER",e.BOOLEAN="BOOLEAN",e.ARRAY="ARRAY",e.OBJECT="OBJECT",e.NULL="NULL"})(I||(I={}));var ue;(function(e){e.API_SPEC_UNSPECIFIED="API_SPEC_UNSPECIFIED",e.SIMPLE_SEARCH="SIMPLE_SEARCH",e.ELASTIC_SEARCH="ELASTIC_SEARCH"})(ue||(ue={}));var pe;(function(e){e.AUTH_TYPE_UNSPECIFIED="AUTH_TYPE_UNSPECIFIED",e.NO_AUTH="NO_AUTH",e.API_KEY_AUTH="API_KEY_AUTH",e.HTTP_BASIC_AUTH="HTTP_BASIC_AUTH",e.GOOGLE_SERVICE_ACCOUNT_AUTH="GOOGLE_SERVICE_ACCOUNT_AUTH",e.OAUTH="OAUTH",e.OIDC_AUTH="OIDC_AUTH"})(pe||(pe={}));var ge;(function(e){e.HTTP_IN_UNSPECIFIED="HTTP_IN_UNSPECIFIED",e.HTTP_IN_QUERY="HTTP_IN_QUERY",e.HTTP_IN_HEADER="HTTP_IN_HEADER",e.HTTP_IN_PATH="HTTP_IN_PATH",e.HTTP_IN_BODY="HTTP_IN_BODY",e.HTTP_IN_COOKIE="HTTP_IN_COOKIE"})(ge||(ge={}));var ye;(function(e){e.PHISH_BLOCK_THRESHOLD_UNSPECIFIED="PHISH_BLOCK_THRESHOLD_UNSPECIFIED",e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_HIGH_AND_ABOVE="BLOCK_HIGH_AND_ABOVE",e.BLOCK_HIGHER_AND_ABOVE="BLOCK_HIGHER_AND_ABOVE",e.BLOCK_VERY_HIGH_AND_ABOVE="BLOCK_VERY_HIGH_AND_ABOVE",e.BLOCK_ONLY_EXTREMELY_HIGH="BLOCK_ONLY_EXTREMELY_HIGH"})(ye||(ye={}));var fe;(function(e){e.UNSPECIFIED="UNSPECIFIED",e.BLOCKING="BLOCKING",e.NON_BLOCKING="NON_BLOCKING"})(fe||(fe={}));var be;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.MODE_DYNAMIC="MODE_DYNAMIC"})(be||(be={}));var we;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.AUTO="AUTO",e.ANY="ANY",e.NONE="NONE",e.VALIDATED="VALIDATED"})(we||(we={}));var ve;(function(e){e.THINKING_LEVEL_UNSPECIFIED="THINKING_LEVEL_UNSPECIFIED",e.LOW="LOW",e.MEDIUM="MEDIUM",e.HIGH="HIGH",e.MINIMAL="MINIMAL"})(ve||(ve={}));var xe;(function(e){e.HARM_CATEGORY_UNSPECIFIED="HARM_CATEGORY_UNSPECIFIED",e.HARM_CATEGORY_HARASSMENT="HARM_CATEGORY_HARASSMENT",e.HARM_CATEGORY_HATE_SPEECH="HARM_CATEGORY_HATE_SPEECH",e.HARM_CATEGORY_SEXUALLY_EXPLICIT="HARM_CATEGORY_SEXUALLY_EXPLICIT",e.HARM_CATEGORY_DANGEROUS_CONTENT="HARM_CATEGORY_DANGEROUS_CONTENT",e.HARM_CATEGORY_CIVIC_INTEGRITY="HARM_CATEGORY_CIVIC_INTEGRITY",e.HARM_CATEGORY_IMAGE_HATE="HARM_CATEGORY_IMAGE_HATE",e.HARM_CATEGORY_IMAGE_DANGEROUS_CONTENT="HARM_CATEGORY_IMAGE_DANGEROUS_CONTENT",e.HARM_CATEGORY_IMAGE_HARASSMENT="HARM_CATEGORY_IMAGE_HARASSMENT",e.HARM_CATEGORY_IMAGE_SEXUALLY_EXPLICIT="HARM_CATEGORY_IMAGE_SEXUALLY_EXPLICIT",e.HARM_CATEGORY_JAILBREAK="HARM_CATEGORY_JAILBREAK"})(xe||(xe={}));var Ie;(function(e){e.HARM_BLOCK_METHOD_UNSPECIFIED="HARM_BLOCK_METHOD_UNSPECIFIED",e.SEVERITY="SEVERITY",e.PROBABILITY="PROBABILITY"})(Ie||(Ie={}));var Ae;(function(e){e.HARM_BLOCK_THRESHOLD_UNSPECIFIED="HARM_BLOCK_THRESHOLD_UNSPECIFIED",e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_ONLY_HIGH="BLOCK_ONLY_HIGH",e.BLOCK_NONE="BLOCK_NONE",e.OFF="OFF"})(Ae||(Ae={}));var Ce;(function(e){e.FINISH_REASON_UNSPECIFIED="FINISH_REASON_UNSPECIFIED",e.STOP="STOP",e.MAX_TOKENS="MAX_TOKENS",e.SAFETY="SAFETY",e.RECITATION="RECITATION",e.LANGUAGE="LANGUAGE",e.OTHER="OTHER",e.BLOCKLIST="BLOCKLIST",e.PROHIBITED_CONTENT="PROHIBITED_CONTENT",e.SPII="SPII",e.MALFORMED_FUNCTION_CALL="MALFORMED_FUNCTION_CALL",e.IMAGE_SAFETY="IMAGE_SAFETY",e.UNEXPECTED_TOOL_CALL="UNEXPECTED_TOOL_CALL",e.IMAGE_PROHIBITED_CONTENT="IMAGE_PROHIBITED_CONTENT",e.NO_IMAGE="NO_IMAGE",e.IMAGE_RECITATION="IMAGE_RECITATION",e.IMAGE_OTHER="IMAGE_OTHER"})(Ce||(Ce={}));var Te;(function(e){e.HARM_PROBABILITY_UNSPECIFIED="HARM_PROBABILITY_UNSPECIFIED",e.NEGLIGIBLE="NEGLIGIBLE",e.LOW="LOW",e.MEDIUM="MEDIUM",e.HIGH="HIGH"})(Te||(Te={}));var _e;(function(e){e.HARM_SEVERITY_UNSPECIFIED="HARM_SEVERITY_UNSPECIFIED",e.HARM_SEVERITY_NEGLIGIBLE="HARM_SEVERITY_NEGLIGIBLE",e.HARM_SEVERITY_LOW="HARM_SEVERITY_LOW",e.HARM_SEVERITY_MEDIUM="HARM_SEVERITY_MEDIUM",e.HARM_SEVERITY_HIGH="HARM_SEVERITY_HIGH"})(_e||(_e={}));var ke;(function(e){e.URL_RETRIEVAL_STATUS_UNSPECIFIED="URL_RETRIEVAL_STATUS_UNSPECIFIED",e.URL_RETRIEVAL_STATUS_SUCCESS="URL_RETRIEVAL_STATUS_SUCCESS",e.URL_RETRIEVAL_STATUS_ERROR="URL_RETRIEVAL_STATUS_ERROR",e.URL_RETRIEVAL_STATUS_PAYWALL="URL_RETRIEVAL_STATUS_PAYWALL",e.URL_RETRIEVAL_STATUS_UNSAFE="URL_RETRIEVAL_STATUS_UNSAFE"})(ke||(ke={}));var Se;(function(e){e.BLOCKED_REASON_UNSPECIFIED="BLOCKED_REASON_UNSPECIFIED",e.SAFETY="SAFETY",e.OTHER="OTHER",e.BLOCKLIST="BLOCKLIST",e.PROHIBITED_CONTENT="PROHIBITED_CONTENT",e.IMAGE_SAFETY="IMAGE_SAFETY",e.MODEL_ARMOR="MODEL_ARMOR",e.JAILBREAK="JAILBREAK"})(Se||(Se={}));var Ee;(function(e){e.TRAFFIC_TYPE_UNSPECIFIED="TRAFFIC_TYPE_UNSPECIFIED",e.ON_DEMAND="ON_DEMAND",e.PROVISIONED_THROUGHPUT="PROVISIONED_THROUGHPUT"})(Ee||(Ee={}));var Pe;(function(e){e.MODALITY_UNSPECIFIED="MODALITY_UNSPECIFIED",e.TEXT="TEXT",e.IMAGE="IMAGE",e.AUDIO="AUDIO"})(Pe||(Pe={}));var Me;(function(e){e.MEDIA_RESOLUTION_UNSPECIFIED="MEDIA_RESOLUTION_UNSPECIFIED",e.MEDIA_RESOLUTION_LOW="MEDIA_RESOLUTION_LOW",e.MEDIA_RESOLUTION_MEDIUM="MEDIA_RESOLUTION_MEDIUM",e.MEDIA_RESOLUTION_HIGH="MEDIA_RESOLUTION_HIGH"})(Me||(Me={}));var qe;(function(e){e.TUNING_MODE_UNSPECIFIED="TUNING_MODE_UNSPECIFIED",e.TUNING_MODE_FULL="TUNING_MODE_FULL",e.TUNING_MODE_PEFT_ADAPTER="TUNING_MODE_PEFT_ADAPTER"})(qe||(qe={}));var Re;(function(e){e.ADAPTER_SIZE_UNSPECIFIED="ADAPTER_SIZE_UNSPECIFIED",e.ADAPTER_SIZE_ONE="ADAPTER_SIZE_ONE",e.ADAPTER_SIZE_TWO="ADAPTER_SIZE_TWO",e.ADAPTER_SIZE_FOUR="ADAPTER_SIZE_FOUR",e.ADAPTER_SIZE_EIGHT="ADAPTER_SIZE_EIGHT",e.ADAPTER_SIZE_SIXTEEN="ADAPTER_SIZE_SIXTEEN",e.ADAPTER_SIZE_THIRTY_TWO="ADAPTER_SIZE_THIRTY_TWO"})(Re||(Re={}));var Oe;(function(e){e.JOB_STATE_UNSPECIFIED="JOB_STATE_UNSPECIFIED",e.JOB_STATE_QUEUED="JOB_STATE_QUEUED",e.JOB_STATE_PENDING="JOB_STATE_PENDING",e.JOB_STATE_RUNNING="JOB_STATE_RUNNING",e.JOB_STATE_SUCCEEDED="JOB_STATE_SUCCEEDED",e.JOB_STATE_FAILED="JOB_STATE_FAILED",e.JOB_STATE_CANCELLING="JOB_STATE_CANCELLING",e.JOB_STATE_CANCELLED="JOB_STATE_CANCELLED",e.JOB_STATE_PAUSED="JOB_STATE_PAUSED",e.JOB_STATE_EXPIRED="JOB_STATE_EXPIRED",e.JOB_STATE_UPDATING="JOB_STATE_UPDATING",e.JOB_STATE_PARTIALLY_SUCCEEDED="JOB_STATE_PARTIALLY_SUCCEEDED"})(Oe||(Oe={}));var De;(function(e){e.TUNING_TASK_UNSPECIFIED="TUNING_TASK_UNSPECIFIED",e.TUNING_TASK_I2V="TUNING_TASK_I2V",e.TUNING_TASK_T2V="TUNING_TASK_T2V",e.TUNING_TASK_R2V="TUNING_TASK_R2V"})(De||(De={}));var Ne;(function(e){e.MEDIA_RESOLUTION_UNSPECIFIED="MEDIA_RESOLUTION_UNSPECIFIED",e.MEDIA_RESOLUTION_LOW="MEDIA_RESOLUTION_LOW",e.MEDIA_RESOLUTION_MEDIUM="MEDIA_RESOLUTION_MEDIUM",e.MEDIA_RESOLUTION_HIGH="MEDIA_RESOLUTION_HIGH",e.MEDIA_RESOLUTION_ULTRA_HIGH="MEDIA_RESOLUTION_ULTRA_HIGH"})(Ne||(Ne={}));var He;(function(e){e.COLLECTION="COLLECTION"})(He||(He={}));var Le;(function(e){e.FEATURE_SELECTION_PREFERENCE_UNSPECIFIED="FEATURE_SELECTION_PREFERENCE_UNSPECIFIED",e.PRIORITIZE_QUALITY="PRIORITIZE_QUALITY",e.BALANCED="BALANCED",e.PRIORITIZE_COST="PRIORITIZE_COST"})(Le||(Le={}));var Ge;(function(e){e.ENVIRONMENT_UNSPECIFIED="ENVIRONMENT_UNSPECIFIED",e.ENVIRONMENT_BROWSER="ENVIRONMENT_BROWSER"})(Ge||(Ge={}));var Be;(function(e){e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_ONLY_HIGH="BLOCK_ONLY_HIGH",e.BLOCK_NONE="BLOCK_NONE"})(Be||(Be={}));var We;(function(e){e.DONT_ALLOW="DONT_ALLOW",e.ALLOW_ADULT="ALLOW_ADULT",e.ALLOW_ALL="ALLOW_ALL"})(We||(We={}));var Fe;(function(e){e.auto="auto",e.en="en",e.ja="ja",e.ko="ko",e.hi="hi",e.zh="zh",e.pt="pt",e.es="es"})(Fe||(Fe={}));var Ue;(function(e){e.MASK_MODE_DEFAULT="MASK_MODE_DEFAULT",e.MASK_MODE_USER_PROVIDED="MASK_MODE_USER_PROVIDED",e.MASK_MODE_BACKGROUND="MASK_MODE_BACKGROUND",e.MASK_MODE_FOREGROUND="MASK_MODE_FOREGROUND",e.MASK_MODE_SEMANTIC="MASK_MODE_SEMANTIC"})(Ue||(Ue={}));var ze;(function(e){e.CONTROL_TYPE_DEFAULT="CONTROL_TYPE_DEFAULT",e.CONTROL_TYPE_CANNY="CONTROL_TYPE_CANNY",e.CONTROL_TYPE_SCRIBBLE="CONTROL_TYPE_SCRIBBLE",e.CONTROL_TYPE_FACE_MESH="CONTROL_TYPE_FACE_MESH"})(ze||(ze={}));var Ve;(function(e){e.SUBJECT_TYPE_DEFAULT="SUBJECT_TYPE_DEFAULT",e.SUBJECT_TYPE_PERSON="SUBJECT_TYPE_PERSON",e.SUBJECT_TYPE_ANIMAL="SUBJECT_TYPE_ANIMAL",e.SUBJECT_TYPE_PRODUCT="SUBJECT_TYPE_PRODUCT"})(Ve||(Ve={}));var Ye;(function(e){e.EDIT_MODE_DEFAULT="EDIT_MODE_DEFAULT",e.EDIT_MODE_INPAINT_REMOVAL="EDIT_MODE_INPAINT_REMOVAL",e.EDIT_MODE_INPAINT_INSERTION="EDIT_MODE_INPAINT_INSERTION",e.EDIT_MODE_OUTPAINT="EDIT_MODE_OUTPAINT",e.EDIT_MODE_CONTROLLED_EDITING="EDIT_MODE_CONTROLLED_EDITING",e.EDIT_MODE_STYLE="EDIT_MODE_STYLE",e.EDIT_MODE_BGSWAP="EDIT_MODE_BGSWAP",e.EDIT_MODE_PRODUCT_IMAGE="EDIT_MODE_PRODUCT_IMAGE"})(Ye||(Ye={}));var Ze;(function(e){e.FOREGROUND="FOREGROUND",e.BACKGROUND="BACKGROUND",e.PROMPT="PROMPT",e.SEMANTIC="SEMANTIC",e.INTERACTIVE="INTERACTIVE"})(Ze||(Ze={}));var Ke;(function(e){e.ASSET="ASSET",e.STYLE="STYLE"})(Ke||(Ke={}));var je;(function(e){e.INSERT="INSERT",e.REMOVE="REMOVE",e.REMOVE_STATIC="REMOVE_STATIC",e.OUTPAINT="OUTPAINT"})(je||(je={}));var Qe;(function(e){e.OPTIMIZED="OPTIMIZED",e.LOSSLESS="LOSSLESS"})(Qe||(Qe={}));var $e;(function(e){e.SUPERVISED_FINE_TUNING="SUPERVISED_FINE_TUNING",e.PREFERENCE_TUNING="PREFERENCE_TUNING"})($e||($e={}));var Je;(function(e){e.STATE_UNSPECIFIED="STATE_UNSPECIFIED",e.STATE_PENDING="STATE_PENDING",e.STATE_ACTIVE="STATE_ACTIVE",e.STATE_FAILED="STATE_FAILED"})(Je||(Je={}));var Xe;(function(e){e.STATE_UNSPECIFIED="STATE_UNSPECIFIED",e.PROCESSING="PROCESSING",e.ACTIVE="ACTIVE",e.FAILED="FAILED"})(Xe||(Xe={}));var ei;(function(e){e.SOURCE_UNSPECIFIED="SOURCE_UNSPECIFIED",e.UPLOADED="UPLOADED",e.GENERATED="GENERATED",e.REGISTERED="REGISTERED"})(ei||(ei={}));var ii;(function(e){e.TURN_COMPLETE_REASON_UNSPECIFIED="TURN_COMPLETE_REASON_UNSPECIFIED",e.MALFORMED_FUNCTION_CALL="MALFORMED_FUNCTION_CALL",e.RESPONSE_REJECTED="RESPONSE_REJECTED",e.NEED_MORE_INPUT="NEED_MORE_INPUT"})(ii||(ii={}));var ti;(function(e){e.MODALITY_UNSPECIFIED="MODALITY_UNSPECIFIED",e.TEXT="TEXT",e.IMAGE="IMAGE",e.VIDEO="VIDEO",e.AUDIO="AUDIO",e.DOCUMENT="DOCUMENT"})(ti||(ti={}));var ni;(function(e){e.VAD_SIGNAL_TYPE_UNSPECIFIED="VAD_SIGNAL_TYPE_UNSPECIFIED",e.VAD_SIGNAL_TYPE_SOS="VAD_SIGNAL_TYPE_SOS",e.VAD_SIGNAL_TYPE_EOS="VAD_SIGNAL_TYPE_EOS"})(ni||(ni={}));var ai;(function(e){e.TYPE_UNSPECIFIED="TYPE_UNSPECIFIED",e.ACTIVITY_START="ACTIVITY_START",e.ACTIVITY_END="ACTIVITY_END"})(ai||(ai={}));var oi;(function(e){e.START_SENSITIVITY_UNSPECIFIED="START_SENSITIVITY_UNSPECIFIED",e.START_SENSITIVITY_HIGH="START_SENSITIVITY_HIGH",e.START_SENSITIVITY_LOW="START_SENSITIVITY_LOW"})(oi||(oi={}));var si;(function(e){e.END_SENSITIVITY_UNSPECIFIED="END_SENSITIVITY_UNSPECIFIED",e.END_SENSITIVITY_HIGH="END_SENSITIVITY_HIGH",e.END_SENSITIVITY_LOW="END_SENSITIVITY_LOW"})(si||(si={}));var ri;(function(e){e.ACTIVITY_HANDLING_UNSPECIFIED="ACTIVITY_HANDLING_UNSPECIFIED",e.START_OF_ACTIVITY_INTERRUPTS="START_OF_ACTIVITY_INTERRUPTS",e.NO_INTERRUPTION="NO_INTERRUPTION"})(ri||(ri={}));var li;(function(e){e.TURN_COVERAGE_UNSPECIFIED="TURN_COVERAGE_UNSPECIFIED",e.TURN_INCLUDES_ONLY_ACTIVITY="TURN_INCLUDES_ONLY_ACTIVITY",e.TURN_INCLUDES_ALL_INPUT="TURN_INCLUDES_ALL_INPUT"})(li||(li={}));var ci;(function(e){e.SCALE_UNSPECIFIED="SCALE_UNSPECIFIED",e.C_MAJOR_A_MINOR="C_MAJOR_A_MINOR",e.D_FLAT_MAJOR_B_FLAT_MINOR="D_FLAT_MAJOR_B_FLAT_MINOR",e.D_MAJOR_B_MINOR="D_MAJOR_B_MINOR",e.E_FLAT_MAJOR_C_MINOR="E_FLAT_MAJOR_C_MINOR",e.E_MAJOR_D_FLAT_MINOR="E_MAJOR_D_FLAT_MINOR",e.F_MAJOR_D_MINOR="F_MAJOR_D_MINOR",e.G_FLAT_MAJOR_E_FLAT_MINOR="G_FLAT_MAJOR_E_FLAT_MINOR",e.G_MAJOR_E_MINOR="G_MAJOR_E_MINOR",e.A_FLAT_MAJOR_F_MINOR="A_FLAT_MAJOR_F_MINOR",e.A_MAJOR_G_FLAT_MINOR="A_MAJOR_G_FLAT_MINOR",e.B_FLAT_MAJOR_G_MINOR="B_FLAT_MAJOR_G_MINOR",e.B_MAJOR_A_FLAT_MINOR="B_MAJOR_A_FLAT_MINOR"})(ci||(ci={}));var di;(function(e){e.MUSIC_GENERATION_MODE_UNSPECIFIED="MUSIC_GENERATION_MODE_UNSPECIFIED",e.QUALITY="QUALITY",e.DIVERSITY="DIVERSITY",e.VOCALIZATION="VOCALIZATION"})(di||(di={}));var mi;(function(e){e.PLAYBACK_CONTROL_UNSPECIFIED="PLAYBACK_CONTROL_UNSPECIFIED",e.PLAY="PLAY",e.PAUSE="PAUSE",e.STOP="STOP",e.RESET_CONTEXT="RESET_CONTEXT"})(mi||(mi={}));/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */var hi;(function(e){e.PAGED_ITEM_BATCH_JOBS="batchJobs",e.PAGED_ITEM_MODELS="models",e.PAGED_ITEM_TUNING_JOBS="tuningJobs",e.PAGED_ITEM_FILES="files",e.PAGED_ITEM_CACHED_CONTENTS="cachedContents",e.PAGED_ITEM_FILE_SEARCH_STORES="fileSearchStores",e.PAGED_ITEM_DOCUMENTS="documents"})(hi||(hi={}));function F(e,i){var t={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&i.indexOf(n)<0&&(t[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var a=0,n=Object.getOwnPropertySymbols(e);a<n.length;a++)i.indexOf(n[a])<0&&Object.prototype.propertyIsEnumerable.call(e,n[a])&&(t[n[a]]=e[n[a]]);return t}function ui(e){var i=typeof Symbol=="function"&&Symbol.iterator,t=i&&e[i],n=0;if(t)return t.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(i?"Object is not iterable.":"Symbol.iterator is not defined.")}function b(e){return this instanceof b?(this.v=e,this):new b(e)}function D(e,i,t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var n=t.apply(e,i||[]),a,o=[];return a=Object.create((typeof AsyncIterator=="function"?AsyncIterator:Object).prototype),c("next"),c("throw"),c("return",r),a[Symbol.asyncIterator]=function(){return this},a;function r(d){return function(y){return Promise.resolve(y).then(d,s)}}function c(d,y){n[d]&&(a[d]=function(f){return new Promise(function(p,w){o.push([d,f,p,w])>1||u(d,f)})},y&&(a[d]=y(a[d])))}function u(d,y){try{h(n[d](y))}catch(f){l(o[0][3],f)}}function h(d){d.value instanceof b?Promise.resolve(d.value.v).then(g,s):l(o[0][2],d)}function g(d){u("next",d)}function s(d){u("throw",d)}function l(d,y){d(y),o.shift(),o.length&&u(o[0][0],o[0][1])}}function E(e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var i=e[Symbol.asyncIterator],t;return i?i.call(e):(e=typeof ui=="function"?ui(e):e[Symbol.iterator](),t={},n("next"),n("throw"),n("return"),t[Symbol.asyncIterator]=function(){return this},t);function n(o){t[o]=e[o]&&function(r){return new Promise(function(c,u){r=e[o](r),a(c,u,r.done,r.value)})}}function a(o,r,c,u){Promise.resolve(u).then(function(h){o({value:h,done:c})},r)}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let Ri=function(){const{crypto:e}=globalThis;if(e!=null&&e.randomUUID)return Ri=e.randomUUID.bind(e),e.randomUUID();const i=new Uint8Array(1),t=e?()=>e.getRandomValues(i)[0]:()=>Math.random()*255&255;return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,n=>(+n^t()&15>>+n/4).toString(16))};const _t=()=>Ri();/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function $(e){return typeof e=="object"&&e!==null&&("name"in e&&e.name==="AbortError"||"message"in e&&String(e.message).includes("FetchRequestCanceledException"))}const J=e=>{if(e instanceof Error)return e;if(typeof e=="object"&&e!==null){try{if(Object.prototype.toString.call(e)==="[object Error]"){const i=new Error(e.message,e.cause?{cause:e.cause}:{});return e.stack&&(i.stack=e.stack),e.cause&&!i.cause&&(i.cause=e.cause),e.name&&(i.name=e.name),i}}catch{}try{return new Error(JSON.stringify(e))}catch{}}return new Error(e)};/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class C extends Error{}class A extends C{constructor(i,t,n,a){super(`${A.makeMessage(i,t,n)}`),this.status=i,this.headers=a,this.error=t}static makeMessage(i,t,n){const a=t!=null&&t.message?typeof t.message=="string"?t.message:JSON.stringify(t.message):t?JSON.stringify(t):n;return i&&a?`${i} ${a}`:i?`${i} status code (no body)`:a||"(no status code or body)"}static generate(i,t,n,a){if(!i||!a)return new z({message:n,cause:J(t)});const o=t;return i===400?new Di(i,o,n,a):i===401?new Ni(i,o,n,a):i===403?new Hi(i,o,n,a):i===404?new Li(i,o,n,a):i===409?new Gi(i,o,n,a):i===422?new Bi(i,o,n,a):i===429?new Wi(i,o,n,a):i>=500?new Fi(i,o,n,a):new A(i,o,n,a)}}class X extends A{constructor({message:i}={}){super(void 0,void 0,i||"Request was aborted.",void 0)}}class z extends A{constructor({message:i,cause:t}){super(void 0,void 0,i||"Connection error.",void 0),t&&(this.cause=t)}}class Oi extends z{constructor({message:i}={}){super({message:i??"Request timed out."})}}class Di extends A{}class Ni extends A{}class Hi extends A{}class Li extends A{}class Gi extends A{}class Bi extends A{}class Wi extends A{}class Fi extends A{}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const kt=/^[a-z][a-z0-9+.-]*:/i,St=e=>kt.test(e);let ee=e=>(ee=Array.isArray,ee(e));const Et=ee;let Pt=Et;const pi=Pt;function Mt(e){if(!e)return!0;for(const i in e)return!1;return!0}function qt(e,i){return Object.prototype.hasOwnProperty.call(e,i)}const Rt=(e,i)=>{if(typeof i!="number"||!Number.isInteger(i))throw new C(`${e} must be an integer`);if(i<0)throw new C(`${e} must be a positive integer`);return i},Ot=e=>{try{return JSON.parse(e)}catch{return}};/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Dt=e=>new Promise(i=>setTimeout(i,e));/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const k="0.0.1";/**
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function Nt(){return typeof Deno<"u"&&Deno.build!=null?"deno":typeof EdgeRuntime<"u"?"edge":Object.prototype.toString.call(typeof globalThis.process<"u"?globalThis.process:0)==="[object process]"?"node":"unknown"}const Ht=()=>{var e,i,t,n,a;const o=Nt();if(o==="deno")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":k,"X-Stainless-OS":yi(Deno.build.os),"X-Stainless-Arch":gi(Deno.build.arch),"X-Stainless-Runtime":"deno","X-Stainless-Runtime-Version":typeof Deno.version=="string"?Deno.version:(i=(e=Deno.version)===null||e===void 0?void 0:e.deno)!==null&&i!==void 0?i:"unknown"};if(typeof EdgeRuntime<"u")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":k,"X-Stainless-OS":"Unknown","X-Stainless-Arch":`other:${EdgeRuntime}`,"X-Stainless-Runtime":"edge","X-Stainless-Runtime-Version":globalThis.process.version};if(o==="node")return{"X-Stainless-Lang":"js","X-Stainless-Package-Version":k,"X-Stainless-OS":yi((t=globalThis.process.platform)!==null&&t!==void 0?t:"unknown"),"X-Stainless-Arch":gi((n=globalThis.process.arch)!==null&&n!==void 0?n:"unknown"),"X-Stainless-Runtime":"node","X-Stainless-Runtime-Version":(a=globalThis.process.version)!==null&&a!==void 0?a:"unknown"};const r=Lt();return r?{"X-Stainless-Lang":"js","X-Stainless-Package-Version":k,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":`browser:${r.browser}`,"X-Stainless-Runtime-Version":r.version}:{"X-Stainless-Lang":"js","X-Stainless-Package-Version":k,"X-Stainless-OS":"Unknown","X-Stainless-Arch":"unknown","X-Stainless-Runtime":"unknown","X-Stainless-Runtime-Version":"unknown"}};function Lt(){if(typeof navigator>"u"||!navigator)return null;const e=[{key:"edge",pattern:/Edge(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/MSIE(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"ie",pattern:/Trident(?:.*rv\:(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"chrome",pattern:/Chrome(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"firefox",pattern:/Firefox(?:\W+(\d+)\.(\d+)(?:\.(\d+))?)?/},{key:"safari",pattern:/(?:Version\W+(\d+)\.(\d+)(?:\.(\d+))?)?(?:\W+Mobile\S*)?\W+Safari/}];for(const{key:i,pattern:t}of e){const n=t.exec(navigator.userAgent);if(n){const a=n[1]||0,o=n[2]||0,r=n[3]||0;return{browser:i,version:`${a}.${o}.${r}`}}}return null}const gi=e=>e==="x32"?"x32":e==="x86_64"||e==="x64"?"x64":e==="arm"?"arm":e==="aarch64"||e==="arm64"?"arm64":e?`other:${e}`:"unknown",yi=e=>(e=e.toLowerCase(),e.includes("ios")?"iOS":e==="android"?"Android":e==="darwin"?"MacOS":e==="win32"?"Windows":e==="freebsd"?"FreeBSD":e==="openbsd"?"OpenBSD":e==="linux"?"Linux":e?`Other:${e}`:"Unknown");let H;const Gt=()=>H??(H=Ht());/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function Bt(){if(typeof fetch<"u")return fetch;throw new Error("`fetch` is not defined as a global; Either pass `fetch` to the client, `new GeminiNextGenAPIClient({ fetch })` or polyfill the global, `globalThis.fetch = fetch`")}function Ui(...e){const i=globalThis.ReadableStream;if(typeof i>"u")throw new Error("`ReadableStream` is not defined as a global; You will need to polyfill it, `globalThis.ReadableStream = ReadableStream`");return new i(...e)}function Wt(e){let i=Symbol.asyncIterator in e?e[Symbol.asyncIterator]():e[Symbol.iterator]();return Ui({start(){},async pull(t){const{done:n,value:a}=await i.next();n?t.close():t.enqueue(a)},async cancel(){var t;await((t=i.return)===null||t===void 0?void 0:t.call(i))}})}function zi(e){if(e[Symbol.asyncIterator])return e;const i=e.getReader();return{async next(){try{const t=await i.read();return t!=null&&t.done&&i.releaseLock(),t}catch(t){throw i.releaseLock(),t}},async return(){const t=i.cancel();return i.releaseLock(),await t,{done:!0,value:void 0}},[Symbol.asyncIterator](){return this}}}async function Ft(e){var i,t;if(e===null||typeof e!="object")return;if(e[Symbol.asyncIterator]){await((t=(i=e[Symbol.asyncIterator]()).return)===null||t===void 0?void 0:t.call(i));return}const n=e.getReader(),a=n.cancel();n.releaseLock(),await a}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Ut=({headers:e,body:i})=>({bodyHeaders:{"content-type":"application/json"},body:JSON.stringify(i)});/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Vi=()=>{var e;if(typeof File>"u"){const{process:i}=globalThis,t=typeof((e=i==null?void 0:i.versions)===null||e===void 0?void 0:e.node)=="string"&&parseInt(i.versions.node.split("."))<20;throw new Error("`File` is not defined as a global, which is required for file uploads."+(t?" Update to Node 20 LTS or newer, or set `globalThis.File` to `import('node:buffer').File`.":""))}};function Z(e,i,t){return Vi(),new File(e,i??"unknown_file",t)}function zt(e){return(typeof e=="object"&&e!==null&&("name"in e&&e.name&&String(e.name)||"url"in e&&e.url&&String(e.url)||"filename"in e&&e.filename&&String(e.filename)||"path"in e&&e.path&&String(e.path))||"").split(/[\\/]/).pop()||void 0}const Vt=e=>e!=null&&typeof e=="object"&&typeof e[Symbol.asyncIterator]=="function";/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Yi=e=>e!=null&&typeof e=="object"&&typeof e.size=="number"&&typeof e.type=="string"&&typeof e.text=="function"&&typeof e.slice=="function"&&typeof e.arrayBuffer=="function",Yt=e=>e!=null&&typeof e=="object"&&typeof e.name=="string"&&typeof e.lastModified=="number"&&Yi(e),Zt=e=>e!=null&&typeof e=="object"&&typeof e.url=="string"&&typeof e.blob=="function";async function Kt(e,i,t){if(Vi(),e=await e,Yt(e))return e instanceof File?e:Z([await e.arrayBuffer()],e.name);if(Zt(e)){const a=await e.blob();return i||(i=new URL(e.url).pathname.split(/[\\/]/).pop()),Z(await ie(a),i,t)}const n=await ie(e);if(i||(i=zt(e)),!(t!=null&&t.type)){const a=n.find(o=>typeof o=="object"&&"type"in o&&o.type);typeof a=="string"&&(t=Object.assign(Object.assign({},t),{type:a}))}return Z(n,i,t)}async function ie(e){var i,t,n,a,o;let r=[];if(typeof e=="string"||ArrayBuffer.isView(e)||e instanceof ArrayBuffer)r.push(e);else if(Yi(e))r.push(e instanceof Blob?e:await e.arrayBuffer());else if(Vt(e))try{for(var c=!0,u=E(e),h;h=await u.next(),i=h.done,!i;c=!0){a=h.value,c=!1;const g=a;r.push(...await ie(g))}}catch(g){t={error:g}}finally{try{!c&&!i&&(n=u.return)&&await n.call(u)}finally{if(t)throw t.error}}else{const g=(o=e==null?void 0:e.constructor)===null||o===void 0?void 0:o.name;throw new Error(`Unexpected data type: ${typeof e}${g?`; constructor: ${g}`:""}${jt(e)}`)}return r}function jt(e){return typeof e!="object"||e===null?"":`; props: [${Object.getOwnPropertyNames(e).map(t=>`"${t}"`).join(", ")}]`}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class Zi{constructor(i){this._client=i}}Zi._key=[];/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function Ki(e){return e.replace(/[^A-Za-z0-9\-._~!$&'()*+,;=:@]+/g,encodeURIComponent)}const fi=Object.freeze(Object.create(null)),Qt=(e=Ki)=>(function(t,...n){if(t.length===1)return t[0];let a=!1;const o=[],r=t.reduce((g,s,l)=>{var d,y,f;/[?#]/.test(s)&&(a=!0);const p=n[l];let w=(a?encodeURIComponent:e)(""+p);return l!==n.length&&(p==null||typeof p=="object"&&p.toString===((f=Object.getPrototypeOf((y=Object.getPrototypeOf((d=p.hasOwnProperty)!==null&&d!==void 0?d:fi))!==null&&y!==void 0?y:fi))===null||f===void 0?void 0:f.toString))&&(w=p+"",o.push({start:g.length+s.length,length:w.length,error:`Value of type ${Object.prototype.toString.call(p).slice(8,-1)} is not a valid path parameter`})),g+s+(l===n.length?"":w)},""),c=r.split(/[?#]/,1)[0],u=new RegExp("(?<=^|\\/)(?:\\.|%2e){1,2}(?=\\/|$)","gi");let h;for(;(h=u.exec(c))!==null;)o.push({start:h.index,length:h[0].length,error:`Value "${h[0]}" can't be safely passed as a path parameter`});if(o.sort((g,s)=>g.start-s.start),o.length>0){let g=0;const s=o.reduce((l,d)=>{const y=" ".repeat(d.start-g),f="^".repeat(d.length);return g=d.start+d.length,l+y+f},"");throw new C(`Path parameters result in path with invalid segments:
 ...
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class ji extends Zi{create(i,t){var n;const{api_version:a=this._client.apiVersion}=i,o=F(i,["api_version"]);if("model"in o&&"agent_config"in o)throw new C("Invalid request: specified `model` and `agent_config`. If specifying `model`, use `generation_config`.");if("agent"in o&&"generation_config"in o)throw new C("Invalid request: specified `agent` and `generation_config`. If specifying `agent`, use `agent_config`.");return this._client.post(L`/${a}/interactions`,Object.assign(Object.assign({body:o},t),{stream:(n=i.stream)!==null&&n!==void 0?n:!1}))}delete(i,t={},n){const{api_version:a=this._client.apiVersion}=t??{};return this._client.delete(L`/${a}/interactions/${i}`,n)}cancel(i,t={},n){const{api_version:a=this._client.apiVersion}=t??{};return this._client.post(L`/${a}/interactions/${i}/cancel`,n)}get(i,t={},n){var a;const o=t??{},{api_version:r=this._client.apiVersion}=o,c=F(o,["api_version"]);return this._client.get(L`/${r}/interactions/${i}`,Object.assign(Object.assign({query:c},n),{stream:(a=t==null?void 0:t.stream)!==null&&a!==void 0?a:!1}))}}ji._key=Object.freeze(["interactions"]);class Qi extends ji{}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function $t(e){let i=0;for(const a of e)i+=a.length;const t=new Uint8Array(i);let n=0;for(const a of e)t.set(a,n),n+=a.length;return t}let G;function ne(e){let i;return(G??(i=new globalThis.TextEncoder,G=i.encode.bind(i)))(e)}let B;function bi(e){let i;return(B??(i=new globalThis.TextDecoder,B=i.decode.bind(i)))(e)}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class V{constructor(){this.buffer=new Uint8Array,this.carriageReturnIndex=null}decode(i){if(i==null)return[];const t=i instanceof ArrayBuffer?new Uint8Array(i):typeof i=="string"?ne(i):i;this.buffer=$t([this.buffer,t]);const n=[];let a;for(;(a=Jt(this.buffer,this.carriageReturnIndex))!=null;){if(a.carriage&&this.carriageReturnIndex==null){this.carriageReturnIndex=a.index;continue}if(this.carriageReturnIndex!=null&&(a.index!==this.carriageReturnIndex+1||a.carriage)){n.push(bi(this.buffer.subarray(0,this.carriageReturnIndex-1))),this.buffer=this.buffer.subarray(this.carriageReturnIndex),this.carriageReturnIndex=null;continue}const o=this.carriageReturnIndex!==null?a.preceding-1:a.preceding,r=bi(this.buffer.subarray(0,o));n.push(r),this.buffer=this.buffer.subarray(a.index),this.carriageReturnIndex=null}return n}flush(){return this.buffer.length?this.decode(`
`):[]}}V.NEWLINE_CHARS=new Set([`
`,"\r"]);V.NEWLINE_REGEXP=/\r\n|[\n\r]/g;function Jt(e,i){for(let a=i??0;a<e.length;a++){if(e[a]===10)return{preceding:a,index:a+1,carriage:!1};if(e[a]===13)return{preceding:a,index:a+1,carriage:!0}}return null}function Xt(e){for(let n=0;n<e.length-1;n++){if(e[n]===10&&e[n+1]===10||e[n]===13&&e[n+1]===13)return n+2;if(e[n]===13&&e[n+1]===10&&n+3<e.length&&e[n+2]===13&&e[n+3]===10)return n+4}return-1}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const U={off:0,error:200,warn:300,info:400,debug:500},wi=(e,i,t)=>{if(e){if(qt(U,e))return e;x(t).warn(`${i} was set to ${JSON.stringify(e)}, expected one of ${JSON.stringify(Object.keys(U))}`)}};function O(){}function W(e,i,t){return!i||U[e]>U[t]?O:i[e].bind(i)}const en={error:O,warn:O,info:O,debug:O};let vi=new WeakMap;function x(e){var i;const t=e.logger,n=(i=e.logLevel)!==null&&i!==void 0?i:"off";if(!t)return en;const a=vi.get(t);if(a&&a[0]===n)return a[1];const o={error:W("error",t,n),warn:W("warn",t,n),info:W("info",t,n),debug:W("debug",t,n)};return vi.set(t,[n,o]),o}const _=e=>(e.options&&(e.options=Object.assign({},e.options),delete e.options.headers),e.headers&&(e.headers=Object.fromEntries((e.headers instanceof Headers?[...e.headers]:Object.entries(e.headers)).map(([i,t])=>[i,i.toLowerCase()==="x-goog-api-key"||i.toLowerCase()==="authorization"||i.toLowerCase()==="cookie"||i.toLowerCase()==="set-cookie"?"***":t]))),"retryOfRequestLogID"in e&&(e.retryOfRequestLogID&&(e.retryOf=e.retryOfRequestLogID),delete e.retryOfRequestLogID),e);/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class S{constructor(i,t,n){this.iterator=i,this.controller=t,this.client=n}static fromSSEResponse(i,t,n){let a=!1;const o=n?x(n):console;function r(){return D(this,arguments,function*(){var u,h,g,s;if(a)throw new C("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");a=!0;let l=!1;try{try{for(var d=!0,y=E(tn(i,t)),f;f=yield b(y.next()),u=f.done,!u;d=!0){s=f.value,d=!1;const p=s;if(!l)if(p.data.startsWith("[DONE]")){l=!0;continue}else try{yield yield b(JSON.parse(p.data))}catch(w){throw o.error("Could not parse message into JSON:",p.data),o.error("From chunk:",p.raw),w}}}catch(p){h={error:p}}finally{try{!d&&!u&&(g=y.return)&&(yield b(g.call(y)))}finally{if(h)throw h.error}}l=!0}catch(p){if($(p))return yield b(void 0);throw p}finally{l||t.abort()}})}return new S(r,t,n)}static fromReadableStream(i,t,n){let a=!1;function o(){return D(this,arguments,function*(){var u,h,g,s;const l=new V,d=zi(i);try{for(var y=!0,f=E(d),p;p=yield b(f.next()),u=p.done,!u;y=!0){s=p.value,y=!1;const w=s;for(const P of l.decode(w))yield yield b(P)}}catch(w){h={error:w}}finally{try{!y&&!u&&(g=f.return)&&(yield b(g.call(f)))}finally{if(h)throw h.error}}for(const w of l.flush())yield yield b(w)})}function r(){return D(this,arguments,function*(){var u,h,g,s;if(a)throw new C("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");a=!0;let l=!1;try{try{for(var d=!0,y=E(o()),f;f=yield b(y.next()),u=f.done,!u;d=!0){s=f.value,d=!1;const p=s;l||p&&(yield yield b(JSON.parse(p)))}}catch(p){h={error:p}}finally{try{!d&&!u&&(g=y.return)&&(yield b(g.call(y)))}finally{if(h)throw h.error}}l=!0}catch(p){if($(p))return yield b(void 0);throw p}finally{l||t.abort()}})}return new S(r,t,n)}[Symbol.asyncIterator](){return this.iterator()}tee(){const i=[],t=[],n=this.iterator(),a=o=>({next:()=>{if(o.length===0){const r=n.next();i.push(r),t.push(r)}return o.shift()}});return[new S(()=>a(i),this.controller,this.client),new S(()=>a(t),this.controller,this.client)]}toReadableStream(){const i=this;let t;return Ui({async start(){t=i[Symbol.asyncIterator]()},async pull(n){try{const{value:a,done:o}=await t.next();if(o)return n.close();const r=ne(JSON.stringify(a)+`
`);n.enqueue(r)}catch(a){n.error(a)}},async cancel(){var n;await((n=t.return)===null||n===void 0?void 0:n.call(t))}})}}function tn(e,i){return D(this,arguments,function*(){var n,a,o,r;if(!e.body)throw i.abort(),typeof globalThis.navigator<"u"&&globalThis.navigator.product==="ReactNative"?new C("The default react-native fetch implementation does not support streaming. Please use expo/fetch: https://docs.expo.dev/versions/latest/sdk/expo/#expofetch-api"):new C("Attempted to iterate over a response with no body");const c=new an,u=new V,h=zi(e.body);try{for(var g=!0,s=E(nn(h)),l;l=yield b(s.next()),n=l.done,!n;g=!0){r=l.value,g=!1;const d=r;for(const y of u.decode(d)){const f=c.decode(y);f&&(yield yield b(f))}}}catch(d){a={error:d}}finally{try{!g&&!n&&(o=s.return)&&(yield b(o.call(s)))}finally{if(a)throw a.error}}for(const d of u.flush()){const y=c.decode(d);y&&(yield yield b(y))}})}function nn(e){return D(this,arguments,function*(){var t,n,a,o;let r=new Uint8Array;try{for(var c=!0,u=E(e),h;h=yield b(u.next()),t=h.done,!t;c=!0){o=h.value,c=!1;const g=o;if(g==null)continue;const s=g instanceof ArrayBuffer?new Uint8Array(g):typeof g=="string"?ne(g):g;let l=new Uint8Array(r.length+s.length);l.set(r),l.set(s,r.length),r=l;let d;for(;(d=Xt(r))!==-1;)yield yield b(r.slice(0,d)),r=r.slice(d)}}catch(g){n={error:g}}finally{try{!c&&!t&&(a=u.return)&&(yield b(a.call(u)))}finally{if(n)throw n.error}}r.length>0&&(yield yield b(r))})}class an{constructor(){this.event=null,this.data=[],this.chunks=[]}decode(i){if(i.endsWith("\r")&&(i=i.substring(0,i.length-1)),!i){if(!this.event&&!this.data.length)return null;const o={event:this.event,data:this.data.join(`
`),raw:this.chunks};return this.event=null,this.data=[],this.chunks=[],o}if(this.chunks.push(i),i.startsWith(":"))return null;let[t,n,a]=on(i,":");return a.startsWith(" ")&&(a=a.substring(1)),t==="event"?this.event=a:t==="data"&&this.data.push(a),null}}function on(e,i){const t=e.indexOf(i);return t!==-1?[e.substring(0,t),i,e.substring(t+i.length)]:[e,"",""]}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */async function sn(e,i){const{response:t,requestLogID:n,retryOfRequestLogID:a,startTime:o}=i,r=await(async()=>{var c;if(i.options.stream)return x(e).debug("response",t.status,t.url,t.headers,t.body),i.options.__streamClass?i.options.__streamClass.fromSSEResponse(t,i.controller,e):S.fromSSEResponse(t,i.controller,e);if(t.status===204)return null;if(i.options.__binaryResponse)return t;const u=t.headers.get("content-type"),h=(c=u==null?void 0:u.split(";")[0])===null||c===void 0?void 0:c.trim();return(h==null?void 0:h.includes("application/json"))||(h==null?void 0:h.endsWith("+json"))?await t.json():await t.text()})();return x(e).debug(`[${n}] response parsed`,_({retryOfRequestLogID:a,url:t.url,status:t.status,body:r,durationMs:Date.now()-o})),r}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class ae extends Promise{constructor(i,t,n=sn){super(a=>{a(null)}),this.responsePromise=t,this.parseResponse=n,this.client=i}_thenUnwrap(i){return new ae(this.client,this.responsePromise,async(t,n)=>i(await this.parseResponse(t,n),n))}asResponse(){return this.responsePromise.then(i=>i.response)}async withResponse(){const[i,t]=await Promise.all([this.parse(),this.asResponse()]);return{data:i,response:t}}parse(){return this.parsedPromise||(this.parsedPromise=this.responsePromise.then(i=>this.parseResponse(this.client,i))),this.parsedPromise}then(i,t){return this.parse().then(i,t)}catch(i){return this.parse().catch(i)}finally(i){return this.parse().finally(i)}}/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const $i=Symbol("brand.privateNullableHeaders");function*rn(e){if(!e)return;if($i in e){const{values:n,nulls:a}=e;yield*n.entries();for(const o of a)yield[o,null];return}let i=!1,t;e instanceof Headers?t=e.entries():pi(e)?t=e:(i=!0,t=Object.entries(e??{}));for(let n of t){const a=n[0];if(typeof a!="string")throw new TypeError("expected header name to be a string");const o=pi(n[1])?n[1]:[n[1]];let r=!1;for(const c of o)c!==void 0&&(i&&!r&&(r=!0,yield[a,null]),yield[a,c])}}const q=e=>{const i=new Headers,t=new Set;for(const n of e){const a=new Set;for(const[o,r]of rn(n)){const c=o.toLowerCase();a.has(c)||(i.delete(o),a.add(c)),r===null?(i.delete(o),t.add(c)):(i.append(o,r),t.delete(c))}}return{[$i]:!0,values:i,nulls:t}};/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const K=e=>{var i,t,n,a,o,r;if(typeof globalThis.process<"u")return(n=(t=(i=Tt)===null||i===void 0?void 0:i[e])===null||t===void 0?void 0:t.trim())!==null&&n!==void 0?n:void 0;if(typeof globalThis.Deno<"u")return(r=(o=(a=globalThis.Deno.env)===null||a===void 0?void 0:a.get)===null||o===void 0?void 0:o.call(a,e))===null||r===void 0?void 0:r.trim()};/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */var Ji;class Y{constructor(i){var t,n,a,o,r,c,u,{baseURL:h=K("GEMINI_NEXT_GEN_API_BASE_URL"),apiKey:g=(t=K("GEMINI_API_KEY"))!==null&&t!==void 0?t:null,apiVersion:s="v1beta"}=i,l=F(i,["baseURL","apiKey","apiVersion"]);const d=Object.assign(Object.assign({apiKey:g,apiVersion:s},l),{baseURL:h||"https://generativelanguage.googleapis.com"});this.baseURL=d.baseURL,this.timeout=(n=d.timeout)!==null&&n!==void 0?n:Y.DEFAULT_TIMEOUT,this.logger=(a=d.logger)!==null&&a!==void 0?a:console;const y="warn";this.logLevel=y,this.logLevel=(r=(o=wi(d.logLevel,"ClientOptions.logLevel",this))!==null&&o!==void 0?o:wi(K("GEMINI_NEXT_GEN_API_LOG"),"process.env['GEMINI_NEXT_GEN_API_LOG']",this))!==null&&r!==void 0?r:y,this.fetchOptions=d.fetchOptions,this.maxRetries=(c=d.maxRetries)!==null&&c!==void 0?c:2,this.fetch=(u=d.fetch)!==null&&u!==void 0?u:Bt(),this.encoder=Ut,this._options=d,this.apiKey=g,this.apiVersion=s,this.clientAdapter=d.clientAdapter}withOptions(i){return new this.constructor(Object.assign(Object.assign(Object.assign({},this._options),{baseURL:this.baseURL,maxRetries:this.maxRetries,timeout:this.timeout,logger:this.logger,logLevel:this.logLevel,fetch:this.fetch,fetchOptions:this.fetchOptions,apiKey:this.apiKey,apiVersion:this.apiVersion}),i))}baseURLOverridden(){return this.baseURL!=="https://generativelanguage.googleapis.com"}defaultQuery(){return this._options.defaultQuery}validateHeaders({values:i,nulls:t}){if(!(i.has("authorization")||i.has("x-goog-api-key"))&&!(this.apiKey&&i.get("x-goog-api-key"))&&!t.has("x-goog-api-key"))throw new Error('Could not resolve authentication method. Expected the apiKey to be set. Or for the "x-goog-api-key" headers to be explicitly omitted')}async authHeaders(i){const t=q([i.headers]);if(!(t.values.has("authorization")||t.values.has("x-goog-api-key"))){if(this.apiKey)return q([{"x-goog-api-key":this.apiKey}]);if(this.clientAdapter.isVertexAI())return q([await this.clientAdapter.getAuthHeaders()])}}stringifyQuery(i){return Object.entries(i).filter(([t,n])=>typeof n<"u").map(([t,n])=>{if(typeof n=="string"||typeof n=="number"||typeof n=="boolean")return`${encodeURIComponent(t)}=${encodeURIComponent(n)}`;if(n===null)return`${encodeURIComponent(t)}=`;throw new C(`Cannot stringify type ${typeof n}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`)}).join("&")}getUserAgent(){return`${this.constructor.name}/JS ${k}`}defaultIdempotencyKey(){return`stainless-node-retry-${_t()}`}makeStatusError(i,t,n,a){return A.generate(i,t,n,a)}buildURL(i,t,n){const a=!this.baseURLOverridden()&&n||this.baseURL,o=St(i)?new URL(i):new URL(a+(a.endsWith("/")&&i.startsWith("/")?i.slice(1):i)),r=this.defaultQuery();return Mt(r)||(t=Object.assign(Object.assign({},r),t)),typeof t=="object"&&t&&!Array.isArray(t)&&(o.search=this.stringifyQuery(t)),o.toString()}async prepareOptions(i){if(this.clientAdapter&&this.clientAdapter.isVertexAI()&&!i.path.startsWith(`/${this.apiVersion}/projects/`)){const t=i.path.slice(this.apiVersion.length+1);i.path=`/${this.apiVersion}/projects/${this.clientAdapter.getProject()}/locations/${this.clientAdapter.getLocation()}${t}`}}async prepareRequest(i,{url:t,options:n}){}get(i,t){return this.methodRequest("get",i,t)}post(i,t){return this.methodRequest("post",i,t)}patch(i,t){return this.methodRequest("patch",i,t)}put(i,t){return this.methodRequest("put",i,t)}delete(i,t){return this.methodRequest("delete",i,t)}methodRequest(i,t,n){return this.request(Promise.resolve(n).then(a=>Object.assign({method:i,path:t},a)))}request(i,t=null){return new ae(this,this.makeRequest(i,t,void 0))}async makeRequest(i,t,n){var a,o,r;const c=await i,u=(a=c.maxRetries)!==null&&a!==void 0?a:this.maxRetries;t==null&&(t=u),await this.prepareOptions(c);const{req:h,url:g,timeout:s}=await this.buildRequest(c,{retryCount:u-t});await this.prepareRequest(h,{url:g,options:c});const l="log_"+(Math.random()*(1<<24)|0).toString(16).padStart(6,"0"),d=n===void 0?"":`, retryOf: ${n}`,y=Date.now();if(x(this).debug(`[${l}] sending request`,_({retryOfRequestLogID:n,method:c.method,url:g,options:c,headers:h.headers})),!((o=c.signal)===null||o===void 0)&&o.aborted)throw new X;const f=new AbortController,p=await this.fetchWithTimeout(g,h,s,f).catch(J),w=Date.now();if(p instanceof globalThis.Error){const M=`retrying, ${t} attempts remaining`;if(!((r=c.signal)===null||r===void 0)&&r.aborted)throw new X;const T=$(p)||/timed? ?out/i.test(String(p)+("cause"in p?String(p.cause):""));if(t)return x(this).info(`[${l}] connection ${T?"timed out":"failed"} - ${M}`),x(this).debug(`[${l}] connection ${T?"timed out":"failed"} (${M})`,_({retryOfRequestLogID:n,url:g,durationMs:w-y,message:p.message})),this.retryRequest(c,t,n??l);throw x(this).info(`[${l}] connection ${T?"timed out":"failed"} - error; no more retries left`),x(this).debug(`[${l}] connection ${T?"timed out":"failed"} (error; no more retries left)`,_({retryOfRequestLogID:n,url:g,durationMs:w-y,message:p.message})),T?new Oi:new z({cause:p})}const P=`[${l}${d}] ${h.method} ${g} ${p.ok?"succeeded":"failed"} with status ${p.status} in ${w-y}ms`;if(!p.ok){const M=await this.shouldRetry(p);if(t&&M){const N=`retrying, ${t} attempts remaining`;return await Ft(p.body),x(this).info(`${P} - ${N}`),x(this).debug(`[${l}] response error (${N})`,_({retryOfRequestLogID:n,url:p.url,status:p.status,headers:p.headers,durationMs:w-y})),this.retryRequest(c,t,n??l,p.headers)}const T=M?"error; no more retries left":"error; not retryable";x(this).info(`${P} - ${T}`);const re=await p.text().catch(N=>J(N).message),le=Ot(re),ce=le?void 0:re;throw x(this).debug(`[${l}] response error (${T})`,_({retryOfRequestLogID:n,url:p.url,status:p.status,headers:p.headers,message:ce,durationMs:Date.now()-y})),this.makeStatusError(p.status,le,ce,p.headers)}return x(this).info(P),x(this).debug(`[${l}] response start`,_({retryOfRequestLogID:n,url:p.url,status:p.status,headers:p.headers,durationMs:w-y})),{response:p,options:c,controller:f,requestLogID:l,retryOfRequestLogID:n,startTime:y}}async fetchWithTimeout(i,t,n,a){const o=t||{},{signal:r,method:c}=o,u=F(o,["signal","method"]);r&&r.addEventListener("abort",()=>a.abort());const h=setTimeout(()=>a.abort(),n),g=globalThis.ReadableStream&&u.body instanceof globalThis.ReadableStream||typeof u.body=="object"&&u.body!==null&&Symbol.asyncIterator in u.body,s=Object.assign(Object.assign(Object.assign({signal:a.signal},g?{duplex:"half"}:{}),{method:"GET"}),u);c&&(s.method=c.toUpperCase());try{return await this.fetch.call(void 0,i,s)}finally{clearTimeout(h)}}async shouldRetry(i){const t=i.headers.get("x-should-retry");return t==="true"?!0:t==="false"?!1:i.status===408||i.status===409||i.status===429||i.status>=500}async retryRequest(i,t,n,a){var o;let r;const c=a==null?void 0:a.get("retry-after-ms");if(c){const h=parseFloat(c);Number.isNaN(h)||(r=h)}const u=a==null?void 0:a.get("retry-after");if(u&&!r){const h=parseFloat(u);Number.isNaN(h)?r=Date.parse(u)-Date.now():r=h*1e3}if(!(r&&0<=r&&r<60*1e3)){const h=(o=i.maxRetries)!==null&&o!==void 0?o:this.maxRetries;r=this.calculateDefaultRetryTimeoutMillis(t,h)}return await Dt(r),this.makeRequest(i,t-1,n)}calculateDefaultRetryTimeoutMillis(i,t){const o=t-i,r=Math.min(.5*Math.pow(2,o),8),c=1-Math.random()*.25;return r*c*1e3}async buildRequest(i,{retryCount:t=0}={}){var n,a,o;const r=Object.assign({},i),{method:c,path:u,query:h,defaultBaseURL:g}=r,s=this.buildURL(u,h,g);"timeout"in r&&Rt("timeout",r.timeout),r.timeout=(n=r.timeout)!==null&&n!==void 0?n:this.timeout;const{bodyHeaders:l,body:d}=this.buildBody({options:r}),y=await this.buildHeaders({options:i,method:c,bodyHeaders:l,retryCount:t});return{req:Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({method:c,headers:y},r.signal&&{signal:r.signal}),globalThis.ReadableStream&&d instanceof globalThis.ReadableStream&&{duplex:"half"}),d&&{body:d}),(a=this.fetchOptions)!==null&&a!==void 0?a:{}),(o=r.fetchOptions)!==null&&o!==void 0?o:{}),url:s,timeout:r.timeout}}async buildHeaders({options:i,method:t,bodyHeaders:n,retryCount:a}){let o={};this.idempotencyHeader&&t!=="get"&&(i.idempotencyKey||(i.idempotencyKey=this.defaultIdempotencyKey()),o[this.idempotencyHeader]=i.idempotencyKey);const r=await this.authHeaders(i);let c=q([o,Object.assign(Object.assign({Accept:"application/json","User-Agent":this.getUserAgent(),"X-Stainless-Retry-Count":String(a)},i.timeout?{"X-Stainless-Timeout":String(Math.trunc(i.timeout/1e3))}:{}),Gt()),this._options.defaultHeaders,n,i.headers,r]);return this.validateHeaders(c),c.values}buildBody({options:{body:i,headers:t}}){if(!i)return{bodyHeaders:void 0,body:void 0};const n=q([t]);return ArrayBuffer.isView(i)||i instanceof ArrayBuffer||i instanceof DataView||typeof i=="string"&&n.values.has("content-type")||globalThis.Blob&&i instanceof globalThis.Blob||i instanceof FormData||i instanceof URLSearchParams||globalThis.ReadableStream&&i instanceof globalThis.ReadableStream?{bodyHeaders:void 0,body:i}:typeof i=="object"&&(Symbol.asyncIterator in i||Symbol.iterator in i&&"next"in i&&typeof i.next=="function")?{bodyHeaders:void 0,body:Wt(i)}:this.encoder({body:i,headers:n})}}Y.DEFAULT_TIMEOUT=6e4;class v extends Y{constructor(){super(...arguments),this.interactions=new Qi(this)}}Ji=v;v.GeminiNextGenAPIClient=Ji;v.GeminiNextGenAPIClientError=C;v.APIError=A;v.APIConnectionError=z;v.APIConnectionTimeoutError=Oi;v.APIUserAbortError=X;v.NotFoundError=Li;v.ConflictError=Gi;v.RateLimitError=Wi;v.BadRequestError=Di;v.AuthenticationError=Ni;v.InternalServerError=Fi;v.PermissionDeniedError=Hi;v.UnprocessableEntityError=Bi;v.toFile=Kt;v.Interactions=Qi;const ln=["Alginate/Agar (Hydrocolloids) are unstable; pour immediately due to syneresis/imbibition.","Condensation reactions release by-products (Water for Polysulfide, Alcohol for C-Silicone) causing shrinkage.","Addition Silicone (PVS) is the most stable (No by-product) but inhibited by Sulfur in Latex gloves.","Polyether is the most hydrophilic elastomer but is very stiff (careful with undercuts).","Thixotropic materials flow under pressure but stay in place when static.","Rapid 'snap' removal of viscoelastic materials reduces permanent deformation."],cn=`
...
Waxes correlation (inlay wax logic)`},{id:"gyp-new-52",question:"While carving an inlay wax pattern, the die surface must resist wear from instruments. This property is mainly provided by:",options:["High setting expansion","High surface hardness/abrasion resistance of Type IV stone","High W/P ratio","Wet/green strength"],correctAnswerIndex:1,explanation:"Wax carving needs a hard die so margins stay sharp."},{id:"gyp-new-53",question:"Type V stone is generally AVOIDED for inlays/onlays because:",options:["It is too weak","It dissolves in water","Higher expansion can make the restoration fit too tight","It cannot be poured into impressions"],correctAnswerIndex:2,explanation:""}],j=["Composites shrink during polymerization (~2-5%); higher filler → less shrinkage.","C-Factor = bonded surface area / unbonded surface area; high C-factor = more stress.","Bis-GMA: high strength, high viscosity, low shrinkage per molecule.","TEGDMA: diluting agent with HIGH shrinkage (low molecular weight).","Higher filler % = lower shrinkage, better mechanical properties.","Incremental layering (≤2 mm) reduces C-factor and ensures complete cure."],Ci=`
...
`,Cn=["Alloy: Mixture of two or more metals.","Phase diagrams: Solid solutions (substitutional vs interstitial).","Heat treatment affects properties (e.g., gold alloys)."],Tn=`
...
`,_n=["Common types: Co-Cr, Ni-Cr, Ti alloys.","High stiffness and hardness compared to noble alloys.","Biocompatibility concerns: Nickel allergy."],kn=`
# Base Metal Alloys
...
`,Sn=["Wrought: Shaped by plastic deformation (cold working).","Fibrous microstructure (not cast grains).","Examples: Orthodontic wires (SS, NiTi, Beta-Ti)."],En=`
# Wrought Alloys
...
`,Pn=["Noble metals (Au, Pt, Pd) are corrosion and oxidation resistant.","Classification depends on noble metal content (High Noble >= 60%, Noble >= 25%).","Gold foil works by cold welding and requires absolute isolation."],Mn=`
...
organic matrix of the resin cement.`}],It=[{id:"cer_mcq_hard_31",question:`Which oxides are specifically added to Noble alloys to form the chemical bond with
...
platinum/gold structure, creating a dense coping.`}],Jn=[{id:"cer_mcq_hard_46",question:`Scenario: A patient returns 2 years after receiving a PFM crown on #8. The gum line has
...
resistance during lab work.`}],Xn=[...vt,...xt,...It,...Jn],ea=[...Xn],At=String.raw`
...
`+te,R=["Thermal Diffusivity = Speed of heat transfer (k / ρCp)","Thermal Conductivity = Quantity of heat transfer","Denture Base: Low diffusivity is desired for insulation but reduces sensation.","Metal Base: High diffusivity restores sensation but transmits hot/cold shock.","CTE Mismatch leads to percolation (microleakage).","Amalgam needs a base because it is a thermal conductor.","Zirconia has transformation toughening (tetragonal to monoclinic expansion)."],oe=()=>{throw new Error("Gemini API key not configured. Set VITE_GEMINI_API_KEY.")},se=e=>e==="FCPS"?`
    ...
    `,la=async(e,i,t)=>{if(e===m.DENTAL_MATERIALS&&t){const c=t.toLowerCase();if(c==="properties - thermal"||c.includes("thermal properties")||c.includes("properties")&&c.includes("thermal"))return{subject:m.DENTAL_MATERIALS,content:te,keyPoints:R}}if(e===m.DENTAL_MATERIALS&&t&&(t.toLowerCase().includes("properties")||t.toLowerCase()==="physical & mechanical properties")){const c=t.toLowerCase();return c.includes("summary")?{subject:m.DENTAL_MATERIALS,content:At,keyPoints:R}:c.includes("mechanical")?{subject:m.DENTAL_MATERIALS,content:Ct,keyPoints:R}:c.includes("thermal")?{subject:m.DENTAL_MATERIALS,content:te,keyPoints:R}:{subject:m.DENTAL_MATERIALS,content:oa,keyPoints:R}}if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("impression"))return{subject:m.DENTAL_MATERIALS,content:cn,keyPoints:ln};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("gypsum"))return{subject:m.DENTAL_MATERIALS,content:dn,keyPoints:mn};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("investment"))return{subject:m.DENTAL_MATERIALS,content:Nn,keyPoints:Hn};if(e===m.DENTAL_MATERIALS&&t&&(t.toLowerCase().includes("gic")||t.toLowerCase().includes("glass ionomer")))return t.toLowerCase().includes("summary")?{subject:m.DENTAL_MATERIALS,content:Mi.content,keyPoints:Mi.keyPoints}:{subject:m.DENTAL_MATERIALS,content:Pi.content,keyPoints:Pi.keyPoints};if(e===m.DENTAL_MATERIALS&&t&&(t.toLowerCase().includes("cement")||t.toLowerCase().includes("liner")||t.toLowerCase().includes("base")))return{subject:m.DENTAL_MATERIALS,content:Fn,keyPoints:Un};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("casting"))return{subject:m.DENTAL_MATERIALS,content:Gn,keyPoints:Bn};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("composite")&&t.toLowerCase().includes("detailed"))return{subject:m.DENTAL_MATERIALS,content:Ci,keyPoints:j};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("composite")&&t.toLowerCase().includes("summary"))return{subject:m.DENTAL_MATERIALS,content:yn,keyPoints:j};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase()==="composite")return{subject:m.DENTAL_MATERIALS,content:Ci,keyPoints:j};if(e===m.DENTAL_MATERIALS&&t&&(t.toLowerCase().includes("adhesion")||t.toLowerCase().includes("bonding")))return{subject:m.DENTAL_MATERIALS,content:wn,keyPoints:bn};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("wax")&&t.toLowerCase().includes("detailed"))return{subject:m.DENTAL_MATERIALS,content:Si,keyPoints:Q};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("wax")&&t.toLowerCase().includes("summary"))return{subject:m.DENTAL_MATERIALS,content:vn,keyPoints:Q};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase()==="wax")return{subject:m.DENTAL_MATERIALS,content:Si,keyPoints:Q};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("metals summary"))return{subject:m.DENTAL_MATERIALS,content:An,keyPoints:In};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase()==="alloys")return{subject:m.DENTAL_MATERIALS,content:Tn,keyPoints:Cn};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("base metal"))return{subject:m.DENTAL_MATERIALS,content:kn,keyPoints:_n};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("wrought"))return{subject:m.DENTAL_MATERIALS,content:En,keyPoints:Sn};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("noble"))return{subject:m.DENTAL_MATERIALS,content:Mn,keyPoints:Pn};if(e===m.DENTAL_MATERIALS&&t&&(t.toLowerCase().includes("ceramic")||t.toLowerCase().includes("porcelain")))return t.toLowerCase().includes("summary")?{subject:m.DENTAL_MATERIALS,content:$n.content,keyPoints:qi}:{subject:m.DENTAL_MATERIALS,content:Qn,keyPoints:qi};if(e===m.DENTAL_MATERIALS&&t&&t.toLowerCase().includes("amalgam"))return t.toLowerCase().includes("summary")?{subject:m.DENTAL_MATERIALS,content:Yn,keyPoints:Ei}:{subject:m.DENTAL_MATERIALS,content:Vn,keyPoints:Ei};const n=oe(),a=se(i),o=t?`Specific Topic: **${t}** (under subject ${e})`:`Subject: **${e}`,r=await n.models.generateContent({model:"gemini-3-flash-preview",contents:`
    ${a}
    ...
    `,config:{responseMimeType:"application/json",responseSchema:{type:I.OBJECT,properties:{subject:{type:I.STRING},content:{type:I.STRING},keyPoints:{type:I.ARRAY,items:{type:I.STRING}}},required:["subject","content","keyPoints"]}}});return JSON.parse(r.text)},ca=async(e,i=5,t,n,a="Medium")=>{if(e===m.DENTAL_MATERIALS&&n&&(n.toLowerCase().includes("properties")||n.toLowerCase()==="physical & mechanical properties")){let s=[];switch(a){case"Easy":s=[...ia];break;case"Hard":s=[...na];break;case"Challenge":s=[...aa];break;case"Medium":default:s=[...ta];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("impression")){let s=[];switch(a){case"Easy":s=[...xi];break;case"Hard":s=[...Ai];break;case"Challenge":s=[...xi,...Ii,...Ai];break;case"Medium":default:s=[...Ii];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("gypsum")){let s=[];switch(a){case"Easy":s=[...hn];break;case"Hard":s=[...pn];break;case"Challenge":s=[...gn];break;case"Medium":default:s=[...un];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("investment")){let s=[];switch(a){case"Easy":s=[...ot];break;case"Hard":s=[...rt];break;case"Challenge":s=[...Ln];break;case"Medium":default:s=[...st];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("casting")){let s=[];switch(a){case"Easy":s=[...lt];break;case"Hard":s=[...dt];break;case"Challenge":s=[...Wn];break;case"Medium":default:s=[...ct];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&(n.toLowerCase().includes("cement")||n.toLowerCase().includes("liner")||n.toLowerCase().includes("base"))){let s=[];switch(a){case"Easy":s=[...mt];break;case"Hard":s=[...ut];break;case"Challenge":s=[...zn];break;case"Medium":default:s=[...ht];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("composite")){let s=[];switch(a){case"Easy":s=[...Xi];break;case"Hard":s=[...it];break;case"Challenge":s=[...fn];break;case"Medium":default:s=[...et];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&(n.toLowerCase().includes("adhesion")||n.toLowerCase().includes("bonding"))){let s=[];switch(a){case"Easy":s=[...Ti];break;case"Hard":s=[...ki];break;case"Challenge":s=[...Ti,..._i,...ki];break;case"Medium":default:s=[..._i];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("wax")){let s=[];switch(a){case"Easy":s=[...tt];break;case"Hard":s=[...at];break;case"Challenge":s=[...xn];break;case"Medium":default:s=[...nt];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("amalgam")){let s=[];switch(a){case"Easy":s=[...pt];break;case"Hard":s=[...yt];break;case"Challenge":s=[...Zn];break;case"Medium":default:s=[...gt];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&(n.toLowerCase().includes("gic")||n.toLowerCase().includes("glass ionomer"))){let s=[];switch(a){case"Easy":s=[...ft];break;case"Hard":s=[...wt];break;case"Challenge":s=[...jn];break;case"Medium":default:s=[...bt];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&n.toLowerCase().includes("metal")){let s=[];switch(a){case"Easy":s=[...qn];break;case"Hard":s=[...On];break;case"Challenge":s=[...Dn];break;case"Medium":default:s=[...Rn];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}if(e===m.DENTAL_MATERIALS&&n&&(n.toLowerCase().includes("ceramic")||n.toLowerCase().includes("porcelain"))){let s=[];switch(a){case"Easy":s=[...vt];break;case"Hard":s=[...It];break;case"Challenge":s=[...ea];break;case"Medium":default:s=[...xt];break}const l=s.sort(()=>.5-Math.random());return l.slice(0,Math.min(i,l.length))}const o=oe();let r=se(t);const c=e==="Comprehensive Mega Test";let u="";if(c){const s=n;u=`Comprehensive Exam covering: ${s}`,r=`You are generating a mixed-subject exam test for the ${t} curriculum. The student has completed the following modules: ${s}. Ensure questions are fairly distributed across these subjects.`}else u=n?`Topic: **${n}** (Subject: ${e})`:`Subject: **${e}**`;let h="";switch(a){case"Easy":h="Questions should be straightforward recall, definitions, or basic concept checks. Options should be clearly distinct.";break;case"Medium":h="Questions should be clinical scenarios or application-based. Options should have good distractors but a clear best answer.";break;case"Hard":case"Challenge":h="Questions should be complex clinical vignettes, requiring multi-step reasoning, diagnosis of rare presentations, or management of complications. Options should be very close distractors requiring precise knowledge.";break}const g=await o.models.generateContent({model:"gemini-3-flash-preview",contents:`
    ...
    2) MODULE_CONTENT: ${c?"Comprehensive Exam - Random Selection from Internal Knowledge Base aligned with Curriculum":r}
    ...
    **Difficulty Level: ${a}**
    ...
    Generate ${i} questions following these requirements:
    ...
    `,config:{responseMimeType:"application/json",responseSchema:{type:I.ARRAY,items:{type:I.OBJECT,properties:{id:{type:I.STRING},question:{type:I.STRING},options:{type:I.ARRAY,items:{type:I.STRING}},correctAnswerIndex:{type:I.NUMBER},explanation:{type:I.STRING}},required:["id","question","options","correctAnswerIndex","explanation"]}}}});return JSON.parse(g.text)},da=async(e,i="BDS")=>{const t=oe(),n=se(i);return(await t.models.generateContent({model:"gemini-3-pro-preview",contents:`
    You are an AI Tutor.
    ${n}
    ...
    `,config:{thinkingConfig:{thinkingBudget:2e3}}})).text};export{ca as a,da as b,la as f};
